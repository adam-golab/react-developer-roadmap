...
你可以在下面找到一张图，该图展示了你成为一名 React开发者可以选取的路径及你想学习的库。“作为 React 开发者，我接下来应该学习什么？”，这张图就是给每个问过我这一问题的人的建议。

## 免责声明

> 该指南的目的是为了给你们有个大概的轮廓。如果你对接下来要学习的内容感到困惑，指南将指导你而不是鼓励你选择新奇的东西。
> 你应该逐渐理解为什么一种工具比另一种更适合某些情况，并且记住新奇的东西并不总是意味着最适合这个工作。
